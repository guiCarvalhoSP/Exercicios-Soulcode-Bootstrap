...
$(document).ready(function () {
    $("#formulario").focusin(function () {
        $("input").css({ backgroundColor: "rgb(233, 233, 233)" });
    })
...
function enviar_dados() {
    ...
    if (!formValido) {
        $( "#aviso" ).show() //Alteração bootstrap
        return formValido;
    }
    else {
...
function grupos_idade(idade) {
    ...
    else if (idade >= 18 && $("#comorbs_sim").prop('checked') == true) {
